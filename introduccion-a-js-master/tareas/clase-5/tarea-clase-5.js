...
$calcularSalarioAnual.onclick = function() {
  ...
  let sueldoMensual = Number(document.querySelector('#salarioMensual').value)
  let sueldoAnual = calcularSalarioAnual(sueldoMensual);
  
  document.querySelector('#salario-anual').value = sueldoAnual;
...
function calcularSalarioAnual(sueldoMensual) {
